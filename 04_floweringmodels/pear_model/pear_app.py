...
def predict_time_dvr(df):
    ...
    col_gdh = [col for col in df.columns if 'DVR2_' in col]
    df = df.melt(id_vars=id_vars, value_vars=col_gdh, var_name="time", value_name='dvr2')
...
def main():
    ...
    output_filename = '../output/pear_result.csv'
